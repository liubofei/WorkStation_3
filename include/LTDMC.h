...
DMC_API short __stdcall dmc_cam_read_points(WORD CardNo, WORD execute,WORD cam_table, WORD cam_chg_point, DWORD cam_point_num, WORD* done,WORD* busy, WORD* error,DWORD* error_id,double* master_pos,double* slave_pos,double* slave_vel,double* slave_acc);
DMC_API short __stdcall dmc_cam_write_points(WORD CardNo, WORD execute,WORD cam_table, DWORD cam_point_num, double master_pos,double slave_pos,double slave_vel,double slave_acc, WORD* done,WORD* busy, WORD* error,DWORD* error_id);
...
DMC_API short __stdcall dmc_set_robot_config(WORD CardNo, WORD Crd, short robot_type, short elbow, double* rx, double* tx, double* rz, double* tz);
DMC_API short __stdcall dmc_get_robot_config(WORD CardNo, WORD Crd, short* robot_type, short* elbow, double* rx, double* tx, double* rz, double* tz);
...
DMC_API short __stdcall dmc_set_robot_user_coordinate(WORD CardNo, WORD Crd, short user_crd, double* p0, double* px, double* py);
DMC_API short __stdcall dmc_set_robot_tool_coordinate(WORD CardNo, WORD Crd, short tool_crd, double* j0, double* j1, double* j2, double* j3, double* j4, double* j5, double* j6, double* j7, double* j8);
...
DMC_API short __stdcall dmc_cam_write_points_packet(WORD CardNo,WORD cam_table_id, WORD cam_point_num, double m_range, double s_range, double * master_pos, double * slave_pos, double * slave_vel, double * slave_acc, double * slave_jerk, WORD* type);

DMC_API short __stdcall dmc_cam_read_points_packet(WORD CardNo,WORD cam_table_id, WORD* cam_point_num, double * m_range, double * s_range, double * master_pos, double * slave_pos, double * slave_vel, double * slave_acc, double * slave_jerk, WORD* type);
