...
SMC_API short __stdcall smc_get_pmove_change_pos_speed_enable(WORD ConnectNo,WORD axis, WORD* enable);
...
SMC_API short __stdcall smc_handwheel_set_emg_logic( WORD ConnectNo, WORD emg_logic);
...
SMC_API short __stdcall smc_conti_ahead_pwm_to_stop(WORD ConnectNo, WORD Crd, WORD pwmno,WORD on_off,double ahead_value,WORD ahead_mode,double ReverseTime);
...
//outmode 0-输出-延时-反转；1-延时-输出；10-输入-输出-延时-反转；11-输入-延时-输出
...
SMC_API short __stdcall smc_trace_add_config_object(WORD ConnectNo, short data_type, short data_index, short data_sub_index, short slave_id, short data_bytes);
SMC_API short __stdcall smc_trace_get_config_object(WORD ConnectNo,short object_index, short * data_type, short * data_index, short * data_sub_index, short * slave_id, short * data_bytes);
SMC_API short __stdcall smc_trace_data_start(WORD ConnectNo);
SMC_API short __stdcall smc_trace_data_stop(WORD ConnectNo);
SMC_API short __stdcall smc_trace_data_reset(WORD ConnectNo);
SMC_API short __stdcall smc_trace_get_flag(WORD ConnectNo,short * start_flag,short * triggered_flag,short * lost_flag);
SMC_API short __stdcall smc_trace_get_state(WORD ConnectNo,int * valid_num,int * free_num,int * object_total_bytes,int * object_total_num);
SMC_API short __stdcall smc_trace_get_data(WORD ConnectNo,int bufsize,unsigned char * data, int * byte_size);
SMC_API short __stdcall smc_trace_reset_lost_flag(WORD ConnectNo);
...
SMC_API short __stdcall smc_pdo_buffer_run_state(WORD ConnectNo,WORD axis,int * RunState,int * Remain,int * NotRunned,int * Runned);
SMC_API short __stdcall smc_pdo_buffer_add_data(WORD ConnectNo,WORD axis, int size, int * data_table);

SMC_API short __stdcall smc_pdo_buffer_start_multi(WORD ConnectNo,WORD AxisNum,WORD * AxisList,WORD * ResultList);
...
SMC_API short __stdcall nmcs_get_pdo_trace_trig_para(WORD ConnectNo,WORD Channel,WORD SlaveAddr,WORD *Trig_Index,WORD *Trig_Sub_Index,int *Trig_Value,WORD *Trig_Mode);
SMC_API short __stdcall nmcs_clear_pdo_trace_data(WORD ConnectNo,WORD Channel,WORD SlaveAddr);
SMC_API short __stdcall nmcs_stop_pdo_trace(WORD ConnectNo,WORD Channel,WORD SlaveAddr);
SMC_API short __stdcall nmcs_read_pdo_trace_data(WORD ConnectNo,WORD Channel,WORD SlaveAddr,DWORD StartAddr,DWORD Readlen,DWORD *ActReadlen,unsigned char *Data);
